...
# simple git test, just check a version is returned but not care about the version number
    ...
    def test_getLatestVersion_GIT(self):
        ...
        self.assertEquals(lazylibrarian.CONFIG['LATEST_VERSION'], result)
