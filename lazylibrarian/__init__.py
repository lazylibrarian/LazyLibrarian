...
USENET_RETENTION = False 
RETENTION_MAXAGE = 1024
...
def initialize():
    ...
    with INIT_LOCK:
	    ...
	    PROXY_HOST, PROXY_TYPE, \
            IMP_ONLYISBN, IMP_PREFLANG, IMP_AUTOADD, SAB_HOST, SAB_PORT, SAB_SUBDIR, SAB_API, SAB_USER, SAB_PASS, DESTINATION_DIR, DESTINATION_COPY, DOWNLOAD_DIR, SAB_CAT, USENET_RETENTION, RETENTION_MAXAGE, NZB_BLACKHOLEDIR, GR_API, GB_API, BOOK_API, \
	...
	PROXY_TYPE = check_setting_str(CFG, 'General','proxy_type', '')
        ...
        USENET_RETENTION = bool(check_setting_int(CFG, 'USENET', 'usenet_retention', 0))
        RETENTION_MAXAGE = check_setting_str(CFG, 'USENET', 'retention_maxage', '')
...
def config_write():
    ...
    new_config['USENET']['retention_maxage'] = RETENTION_MAXAGE
