            ...
            fnUpdate: function (g, l) {
                if (g.aanFeatures.p) {
                    ...
                    for (s = x.length; r < s; r++) if (x[r].childNodes.length !== 0) {
                        ...
                        i(z)
                            .removeClass(v.sPageButton + " " + v.sPageButtonActive + " " + v.sPageButtonStaticDisabled);
                        if (y == 1) {
    ...
    i.fn.dataTable = function (g) {
        ...
        function z(a, b) {
            ...
            if (c.nTr === null) {
                ...
                typeof c._aData.DT_RowClass != "undefined" && i(c.nTr)
                    .addClass(c._aData.DT_RowClass);
        ...
        function V(a) {
            ...
            if (a.nTHead.getElementsByTagName("th")
                .length !== 0) {
                b = 0;
                for (d = a.aoColumns.length; b < d; b++) {
                    c = a.aoColumns[b].nTh;
                    a.aoColumns[b].sClass !== null && i(c)
            ...
            if (a.oFeatures.bSort) for (b = 0; b < a.aoColumns.length; b++) if (a.aoColumns[b].bSortable !== false) {
                ...
                i(a.aoColumns[b].nTh)
                    .bind("mousedown.DT", d)
            } else i(a.aoColumns[b].nTh)
                .addClass(a.oClasses.sSortableNone);
            a.oClasses.sFooterTH !== "" && i(">tr>th", a.nTFoot)
        ...
        function Fa(a) {
            ...
            var b = p.createElement("div"),
                ...
                t = a.nTable.getElementsByTagName("tfoot")
                    .length === 0 ? null : a.nTable.getElementsByTagName("tfoot")[0],
            ...
            a.oScroll.bInfinite && i(f)
                .scroll(function () {
                if (!a.bDrawing) if (i(this)
                    .scrollTop() + i(this)
                    .height() > i(a.nTable)
                    .height() - a.oScroll.iLoadGap) if (a.fnDisplayEnd() < a.fnRecordsDisplay()) {
                    ja(a, "next");
                    E(a);
                    C(a)
                }
        ...
        function Ia(a) {
            ...
            if (a.oScroll.sX === "") {
                ...
                if (i.browser.msie && i.browser.version <= 7) a.nTable.style.width = u(i(a.nTable)
                    .outerWidth() - a.oScroll.iBarWidth)
                ...
                if (i(a.nTable)
                    .outerWidth() > f - a.oScroll.iBarWidth) a.nTable.style.width = u(f)
            ...
            if (i(a.nTable)
                .outerWidth() < f) if (a.oScroll.sX === "") J(a, 1, "The table cannot fit into the current element which will cause column misalignment. It is suggested that you enable x-scrolling or increase the width the table has in which to be drawn");
            ...
            if (a.oScroll.sY !== "" && a.oScroll.bCollapse) {
                ...
                if (a.nTable.offsetHeight < d.offsetHeight) d.style.height = u(i(a.nTable)
                    .height() + j)
            }
            j = i(a.nTable)
                .outerWidth();
        ...
        function Da(a) {
            ...
            b.bind("keyup.DT", function () {
                for (var d = a.aanFeatures.f, f = 0, e = d.length; f < e; f++) d[f] != this.parentNode && i("input", d[f])
                    .val(this.value);
        ...
        function T(a) {
            var b, c, d, f, e, h = a.aoColumns.length,
                j = a.oClasses;
            for (b = 0; b < h; b++) a.aoColumns[b].bSortable && i(a.aoColumns[b].nTh)
                .removeClass(j.sSortAsc + " " + j.sSortDesc + " " + a.aoColumns[b].sSortingClass);
            ...
            if (a.oFeatures.bSort && a.oFeatures.bSortClasses) {
                d = Q(a);
                if (a.oFeatures.bDeferRender) i(d)
                    .removeClass(e + "1 " + e + "2 " + e + "3");
        ...
        function Na(a) {
            if (!(!a.oFeatures.bInfo || a.aanFeatures.i.length === 0)) {
                ...
                e = a.fnRecordsDisplay() === 0 && a.fnRecordsDisplay() == a.fnRecordsTotal() ? a.oLanguage.sInfoEmpty + a.oLanguage.sInfoPostFix : a.fnRecordsDisplay() === 0 ? a.oLanguage.sInfoEmpty + " " + a.oLanguage.sInfoFiltered.replace("_MAX_", j) + a.oLanguage.sInfoPostFix : a.fnRecordsDisplay() == a.fnRecordsTotal() ? a.oLanguage.sInfo.replace("_START_", e)
                    .replace("_END_", h)
                    .replace("_TOTAL_", k) + a.oLanguage.sInfoPostFix : a.oLanguage.sInfo.replace("_START_",
                e)
                    .replace("_END_", h)
                    .replace("_TOTAL_", k) + " " + a.oLanguage.sInfoFiltered.replace("_MAX_", a.fnFormatNumber(a.fnRecordsTotal())) + a.oLanguage.sInfoPostFix;
                if (a.oLanguage.fnInfoCallback !== null) e = a.oLanguage.fnInfoCallback(a, b, c, d, f, e);
                a = a.aanFeatures.i;
                b = 0;
                for (c = a.length; b < c; b++) i(a[b])
                    .html(e)
            }
        }
        ...
        function Ca(a) {
            ...
            i('select option[value="' + a._iDisplayLength + '"]', f)
                .attr("selected", true);
            i("select", f)
                ...
                var e = i(this)
                    ...
                    h = a.aanFeatures.l;
                c = 0;
                for (d = h.length; c < d; c++) h[c] != this.parentNode && i("select", h[c])
                    .val(e);
        ...
        function ea(a) {
            ...
            if (f == h.length && b === 0 && d == f && a.oScroll.sX === "" && a.oScroll.sY === "") for (e = 0; e < a.aoColumns.length; e++) {
                ...
                if (a.oScroll.sX !== "" && a.oScroll.sXInner !== "") b.style.width = u(a.oScroll.sXInner);
                    ...
                    b.style.width = "";
                    if (i(b)
                        .width() < f.offsetWidth) b.style.width = u(f.offsetWidth)
                ...
                if (a.oScroll.sX !== "") {
                    for (e = d = c = 0; e < a.aoColumns.length; e++) if (a.aoColumns[e].bVisible) {
                        c += a.aoColumns[e].sWidthOrig === null ? i(f[d])
                            .outerWidth() : parseInt(a.aoColumns[e].sWidth.replace("px", ""),
                        10) + (i(f[d])
                            .outerWidth() - i(f[d])
                            .width());
                        d++
        ...
        function Qa(a, b) {
            if (a.oScroll.sX === "" && a.oScroll.sY !== "") {
                ...
                b.style.width = u(i(b)
                    .outerWidth() - a.oScroll.iBarWidth)
            } else if (a.oScroll.sX !== "") b.style.width = u(i(b)
                .outerWidth())
        }
            ...
            if (e.oFeatures.bFilter) {
                ...
                if (typeof b == "undefined" || b === null) {
                    ...
                    if (f && typeof e.aanFeatures.f != "undefined") {
                        b = e.aanFeatures.f;
                        c = 0;
                        for (d = b.length; c < d; c++) i("input", b[c])
                            .val(a)
                    }
                } else {
        ...
        this.fnDestroy = function () {
            ...
            T(a);
            i($(a))
                .removeClass(a.asStripClasses.join(" "));
            if (a.bJUI) {
                i("th", a.nTHead)
                    .removeClass([o.oStdClasses.sSortable, o.oJUIClasses.sSortableAsc, o.oJUIClasses.sSortableDesc, o.oJUIClasses.sSortableNone].join(" "));
                i("th span." + o.oJUIClasses.sSortIcon, a.nTHead)
                    .remove();
                i("th", a.nTHead)
                    .each(function () {
                ...
                .removeClass([o.oStdClasses.sSortable, o.oStdClasses.sSortableAsc, o.oStdClasses.sSortableDesc, o.oStdClasses.sSortableNone].join(" "));
            ...
            i(">tr:even", c)
                .addClass(a.asDestoryStrips[0]);
            i(">tr:odd", c)
                .addClass(a.asDestoryStrips[1]);
            d = 0;
        ...
        return this.each(function () {
            ...
            if (this.nodeName.toLowerCase() != "table") J(e, 0, "Attempted to initialise DataTables on a node which is not a table: " + this.nodeName);
                ...
                e.nTable = this;
                e.oInstance = va.length == 1 ? va : i(this)
                    .dataTable();
                e.oApi = va.oApi;
                e.sDestroyWidth = i(this)
                    .width();
                ...
                d = i(">tbody>tr", this);
                a = 0;
                for (b = e.asStripClasses.length; a < b; a++) if (d.filter(":lt(2)")
                ...
                if (c) {
                    ...
                    if (i(d[0])
                        .hasClass(e.oClasses.sStripEven)) e.asDestoryStrips[0] += e.oClasses.sStripEven;
                    if (i(d[1])
                        .hasClass(e.oClasses.sStripOdd)) e.asDestoryStrips[1] += e.oClasses.sStripOdd + " ";
                    if (i(d[1])
                        .hasClass(e.oClasses.sStripEven)) e.asDestoryStrips[1] += e.oClasses.sStripEven;
                ...
                if (typeof g.aoColumnDefs != "undefined") for (a = g.aoColumnDefs.length - 1; a >= 0; a--) {
                    ...
                    for (d = m.length; c < d; c++) if (typeof m[c] == "number" && m[c] >= 0) {
                        ...
                        b = 0;
                        for (f = e.aoColumns.length; b < f; b++) if (m[c] == "_all" || i(e.aoColumns[b].nTh)
                            .hasClass(m[c])) x(e, b, g.aoColumnDefs[a])
                    }
                }
